...
<p class="h3 mt-3 text-center ">Dashboard</p>
  ...
  <a href="admin_member.php">ข้อมูลสมาชิก</a>
  <a href="admin_form.php">ข้อมูลการส่งแบบฟอร์ม</a>
  <a href="admin_contact.php">ข้อมูลติดต่อ</a>
  <a href="admin_katoo.php">กระทู้</a>
